...
public class Program
{
    ...
    private static void HandleCOMServerActivation()
    {
        ...
        var commandProvider = new GitHubExtensionCommandsProvider(savedSearchesPage, signOutPage, signInPage, developerIdProvider, searchRepository, searchPageFactory, addSearchListItem);
